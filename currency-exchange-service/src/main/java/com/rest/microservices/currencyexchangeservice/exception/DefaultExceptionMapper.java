...
import com.rest.microservices.currencyexchangeservice.exception.exceptions.BadRequestException;
import com.rest.microservices.currencyexchangeservice.exception.exceptions.ConflictException;
import com.rest.microservices.currencyexchangeservice.exception.exceptions.ForbiddenException;
...
public class DefaultExceptionMapper {
    ...
    private static final AppLogger LOGGER = AppLogger.getLogger(DefaultExceptionMapper.class);
    ...
    public ErrorMessage internalServerError(Exception e, HttpServletResponse response) {
        ...
        msg.setMessage(e.getMessage());
        msg.setDeveloperMessage("Some thing went Wrong ");
        msg.setReasonCode(500);
        return msg;
    }
}
