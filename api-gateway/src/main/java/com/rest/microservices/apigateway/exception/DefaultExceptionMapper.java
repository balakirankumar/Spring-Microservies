package com.rest.microservices.apigateway.exception;

import com.rest.microservices.apigateway.exception.constants.StatusCode;
import com.rest.microservices.apigateway.exception.exceptions.BadRequestException;
import com.rest.microservices.apigateway.exception.exceptions.ConflictException;
import com.rest.microservices.apigateway.exception.exceptions.ForbiddenException;
import com.rest.microservices.apigateway.exception.exceptions.NotFoundException;
...
public class DefaultExceptionMapper {
    ...
    public ErrorMessage illegalArgumentToBadRequestException(Exception e) {
        ...
        msg.setStatus(HttpStatus.BAD_REQUEST.getReasonPhrase());
        msg.setCode(HttpStatus.BAD_REQUEST.value());
        msg.setMessage(StatusCode._411.getDescription());
